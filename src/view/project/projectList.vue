			...
			<el-table :data="projectList" v-loading="loading" @cell-click="detail" size="medium">
				...
				<el-table-column prop label="操作">
					<template slot-scope="scope">
						<el-link v-if="scope.row.can_view" type="info" icon="el-icon-view" @click.stop="detail(scope.row)">详情</el-link>
						<el-divider v-if="scope.row.can_update" direction="vertical"></el-divider>
						<el-link v-if="scope.row.can_update" type="primary" icon="el-icon-edit" @click.stop="form = scope.row;dialogFormVisible = true; isUpdate = true;">编辑</el-link>
						<el-divider v-if="scope.row.can_delete" direction="vertical"></el-divider>
						<el-link v-if="scope.row.can_delete" type="danger" icon="el-icon-delete" @click.stop="deleteData(scope.row)">删除</el-link>
					</template>
				</el-table-column>
			</el-table>
		</div>
